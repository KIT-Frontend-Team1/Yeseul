...
const ContextQ1Page = () => {
  /*
        ...
        3) 모달창은 ContextQ1Modal 컴포넌트 하나만을 사용합니다.
  ...
  // const { isModalOpen, prevModal } = useContext(ModalStore);
  return (
    <div>
...
// import ContextQ1Detail from "../atom/Q1/Detail";
// import ContextQ1Modal from "../atom/Q1/Modal";
// import ModalStore from "../../../../store/2_context";
...
//   return (
//     <ModalStore.Provider value={[isModalOpen, setIsModalOpen]}>
//       {isModalOpen && <ContextQ1Modal />}
//       <h2>문제 2 - 1</h2>
//       <ContextQ1Detail />
//       <NavigateButton to={"/2_context/q2"} />
